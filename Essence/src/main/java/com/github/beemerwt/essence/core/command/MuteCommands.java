...
public final class MuteCommands {
    public static void register(CommandDispatcher<ServerCommandSource> d) {
        ...
        // /mute <player> [reason...]
        d.register(commandLiteral("essence", "mute")
            .requires(Perms.MUTE::check)
        ...
        d.register(commandLiteral("essence", "tempmute")
            .requires(Perms.TEMP_MUTE::check)
        ...
        // /unmute <player>
        d.register(commandLiteral("essence", "unmute")
            .requires(Perms.UNMUTE::check)
            .then(argument("player", StringArgumentType.word()).suggests(PlayerSuggester.DATABASE)
                .executes(ctx -> {
                    var src = ctx.getSource();
                    var target = getPlayerOrError(ctx);
