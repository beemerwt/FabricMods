...
public final class LocationStore extends BaseStore implements AutoCloseable {
    ...
    public synchronized boolean set(UUID playerId, LocationType type, String key, StoredLocation loc) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(
            ...
            ps.setString(3, key);
            ps.setString(4, loc.worldKey().getValue().toString());
    ...
    public synchronized boolean setSingle(UUID playerId, LocationType type, StoredLocation loc) {
        return set(playerId, type, "_", loc);
    }
    ...
    public synchronized Optional<StoredLocation> getSingle(UUID uuid, LocationType locationType) {
        return get(uuid, locationType, "_");
    }
    ...
    public void deleteSingle(UUID uuid, LocationType locationType) {
        delete(uuid, locationType, "_");
    }
